...
To view the files locally, there is a small web server script included. Drag the `localserver.command` file to a terminal window. Select the `Output Folder` above. A browser window will open for local viewing.
